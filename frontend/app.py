    ...
    with tab_overview:
        if df_global.empty:
            ...
            with c1:
                ...
                st.plotly_chart(fig_gen, use_container_width=True, theme="streamlit")
            ...
            with c2:
                ...
                fig_active.update_layout(barmode='stack', showlegend=True,
                    ...
                    paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
                st.plotly_chart(fig_active, use_container_width=True, theme="streamlit")
            ...
            with c4:
                ...
                st.plotly_chart(fig_score, use_container_width=True, theme="streamlit")
            ...
            with c5:
                ...
                st.plotly_chart(fig_prod, use_container_width=True, theme="streamlit")
            ...
            with c6:
                ...
                try:
                    ...
                    if info_res.status_code == 200:
                        ...
                        st.plotly_chart(fig_driver, use_container_width=True, theme="streamlit")
                except:
            ...
            with c7:
                ...
                st.plotly_chart(fig_bal, use_container_width=True, theme="streamlit")
